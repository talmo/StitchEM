function matches = find_matching_features(sections, features, parameters)
%FIND_MATCHING_FEATURES Takes a cell array of sections and features and
% finds matches both within the section as well as across sections.
...
%% Find XY matches in individual sections
