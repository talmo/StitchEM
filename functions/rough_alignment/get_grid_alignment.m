...
%   grid_alignment = GET_GRID_ALIGNMENT(sec, overlap)
%
% Args:
%   sec is a section structure generated by load_sec.
...
% are at the origin.
%
% See also: estimate_tile_grid_alignments, rough_align_tiles
...
for r = 1:sec.rows
    for c = 1:sec.cols
        % Skip if tile is missing from grid location
